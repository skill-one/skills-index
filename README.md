...
**消费方无需 clone 仓库**，直接拉取发布好的索引快照即可。数据的产生方式见 [docs/DEVELOPMENT.md](docs/DEVELOPMENT.md)（面向开发者）。
...
数据的产生与处理流程：快速开始、数据流概览、命令参考、数据布局与 CI 说明，见 **[docs/DEVELOPMENT.md](docs/DEVELOPMENT.md)**。
